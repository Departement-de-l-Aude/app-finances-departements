...
def generer_graphiques(df_plot, titre, indicateurs, par_habitant=False, afficher_les_deux=False):
    ...
    fig, axes = plt.subplots(lignes, colonnes, figsize=(4*2*colonnes, 3*2*lignes**0.85))    # Affichage des graphiques en 4:3 avec un coeff de taille en + pour qu'il aient toujours la même taille
